...
import (
	...
	"github.com/lowry/demo-go-proj/models"
	"github.com/lowry/demo-go-proj/storage"
...
func (r *Repository) DeleteBook(context *fiber.Ctx) error{
	...
	context.Status(http.StatusOK).JSON(&fiber.Map{"message":"books delete successful"})
	return nil
}
...
func (r *Repository) GetBookById(context *fiber.Ctx) error{
	...
	bookModel := &models.Books{}
	if id == ""{
		context.Status(http.StatusInternalServerError).JSON(&fiber.Map{"message":"item not available"})
		return nil
	}
